resource "databricks_group" "mlops-service-principal-group-staging" {
  display_name = "csels-mlops-dev-service-principals"
...
module "azure_create_sp" {
  ...
  service_principal_name       = "csels-mlops-dev-cicd"
  project_directory_path       = "/csels-mlops-dev"
  azure_tenant_id              = var.azure_tenant_id
  service_principal_group_name = "csels-mlops-dev-service-principals"
}
...
provider "databricks" {
  alias = "staging_sp"
  host  = "https://adb-8219004871211837.17.azuredatabricks.net"
