...
dbutils.widgets.text("experiment_name", "/csels-mlops-dev/csels-mlops-dev-experiment-test", label="MLflow experiment name")

# MLflow registered model name to use for the trained mode..
dbutils.widgets.text("model_name", "csels-mlops-dev-model-test", label="Model Name")
